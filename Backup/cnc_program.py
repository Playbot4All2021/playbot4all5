...
def save_position(x, y, posizione):
    if posizione == 2:
        file = open("/home/pi/Desktop/Playbot4All-main/Backup/positions1.txt", "w")
        file.write(str(x) + "," + str(y) + ",")
        file.close()
        posizione = 1
    else:
        file = open("/home/pi/Desktop/Playbot4All-main/Backup/positions2.txt", "w")
        file.write(str(x) + "," + str(y) + ",")
        file.close()
        posizione = 2

    file = open("/home/pi/Desktop/Playbot4All-main/Backup/valore_posizione.txt", "w")
...
def fix_position():
    ...
    file = open("/home/pi/Desktop/Playbot4All-main/Backup/valore_posizione.txt", "r")
    posizione = file.readline()
    file.close()
    if (int(posizione[0] == 1)):   #Leggo su quale dei due file è stata salvata l'ultima posizione  
        file = open("/home/pi/Desktop/Playbot4All-main/Backup/positions1.txt", "r")            
    else:
        file = open("/home/pi/Desktop/Playbot4All-main/Backup/positions2.txt", "r")
    line = file.readline()
    file.close
    try:
